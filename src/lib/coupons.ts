 ...
 */
export const FIRST_READING_PRICE = 990;
 ...
 * 광고로 이미 990원에 들어온 사람에게 990원 쿠폰이 값을 올려서는 안 된다.
 */
 ...
 *
 * 값이 상품마다 달라지므로 가격 없이는 고를 수 없다. 990원 정액가 쿠폰은
 * 49,900원짜리에서 48,910원을 깎지만 990원짜리에서는 한 푼도 깎지 않는다 -
...
/** 쿠폰함에 크게 적히는 값. 정액가는 "990원", 할인은 "5,000원". */
