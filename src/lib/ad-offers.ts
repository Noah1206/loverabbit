...
export const AD_OFFERS = {
  ...
  breakup_decision_990: {
    ...
    loginReason: "로그인 후 두 사람 정보를 입력하면 이별운 미리보기로 이어져요.",
  },
  inner_mind_990: {
    id: "inner_mind_990",
    category: "sseom",
    ...
    loginReason: "로그인 후 두 사람 정보를 입력하면 썸 사주 미리보기로 이어져요.",
  },
  dohwasal_990: {
    id: "dohwasal_990",
    category: "dohwasal",
    ...
    loginReason: "로그인 후 생년정보를 입력하면 도화살 사주 미리보기로 이어져요.",
  },
  baramgi_990: {
    id: "baramgi_990",
    category: "baramgi",
    ...
    loginReason: "로그인 후 두 사람 정보를 입력하면 바람기 사주 미리보기로 이어져요.",
  },
