...
주인공은 사용자다. 화자는 러브레빗 로고의 토끼 — 사주를 겪는 당사자가 아니라
옆에서 장면을 짚어 주고 어려운 말을 쉬운 말로 풀어 주는 친구다.
...

{
  ...
  "panelLines": [
    { "rabbit": "1번 패널에서 토끼가 하는 말" },
    { "subject": "2번 패널에서 주인공이 속으로 하는 말" },
    { "rabbit": "3번 패널에서 토끼가 하는 말" },
    { "rabbit": "4번 패널에서 토끼가 하는 말" }
  ],
  "captions": ["2번 패널 위 한 줄", "4번 패널 위 한 줄"],
