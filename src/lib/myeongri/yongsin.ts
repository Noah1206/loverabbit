...
import { assessGyeokguk, type GyeokgukAssessment } from "@/lib/myeongri/gyeokguk";
import { strengthPolicyEvidence } from "@/lib/myeongri/strength-policy";
import { stemElementOf } from "@/lib/myeongri/hidden-stems";
