...
import type { Ohaeng, SajuChart } from "@/lib/saju";
import { seasonalContext, elementsPresent, type SeasonalContext } from "@/lib/myeongri/seasonal-context";
import { ruleIsUserFacing, blockersFor, type AdvancedPolicyRule } from "@/lib/myeongri-policy/source-registry";
import TABLE from "@/lib/myeongri-policy/johu-candidates-v1.json";
