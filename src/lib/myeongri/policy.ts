...
import { branchPolarityTable, HIDDEN_STEM_TABLE_VERSION } from "@/lib/myeongri/hidden-stems";
 ...
 *
 * **기본값은 "body" 다.** 지금까지 발급된 리딩이 그 기준으로 나갔기 때문이고,
 * 어느 쪽으로 갈지는 명리 검수가 정할 일이지 코드가 정할 일이 아니다.
 * 영향 규모는 scripts/audit-branch-yinyang.mts 로 직접 재 볼 수 있다.
 */
export type BranchYinYangMode = "body" | "main_hidden_stem";

export const DEFAULT_BRANCH_YIN_YANG_MODE: BranchYinYangMode = "body";
 ...
 */
export const CALCULATION_POLICY_VERSION = "myeongri-policy-1.0.0";
