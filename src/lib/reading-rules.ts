...
export const READING_RULES: ReadingRule[] = [
  ...
  // ── 비연애 2라운드: 건강·가족·이사 (2026-08-31) ──────────
  //
  // 1라운드와 같은 원칙 — 십신 통설(육친 포함)·오행 성정·강약 통설·신살의
  // 기계적 정의에서 온 교과 수준 해석만. 건강 도메인은 의료 판정이 아니라
  // 기운 운용의 리듬으로만 말한다 (가드의 의료 차단과 한편이다).

  {
    id: "HEALTH-TG-BIGYEON",
    priority: 72,
    when: { tenGodAny: ["비견"], domains: ["geongang"] },
    claim: "제 페이스대로 갈 때 오래가는 몸의 결 — 남의 속도에 맞추면 배로 소모되는 구조",
    safePhrasing: "그런 페이스의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 비견은 나와 같은 기운. 제 보폭이 곧 지구력이다.",
  },
  {
    id: "FAMILY-TG-BIGYEON",
    priority: 72,
    when: { tenGodAny: ["비견"], domains: ["gajok"] },
    claim: "형제·또래 가족과 대등하게 서는 결 — 위아래보다 나란히일 때 편한 구조",
    safePhrasing: "그런 나란함의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 비견은 형제의 별. 어깨를 나란히 하는 자리다.",
  },
  {
    id: "MOVE-TG-BIGYEON",
    priority: 72,
    when: { tenGodAny: ["비견"], domains: ["isa"] },
    claim: "제 공간이 따로 서야 하는 결 — 독립·분가에서 기운이 정리되는 구조",
    safePhrasing: "그런 독립의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 비견은 자립의 별. 제 자리를 가를 때 선다.",
  },
  {
    id: "HEALTH-TG-GEOPJAE",
    priority: 72,
    when: { tenGodAny: ["겁재"], domains: ["geongang"] },
    claim: "무리하는 줄 모르고 무리하는 결 — 승부가 걸리면 몸의 신호를 건너뛰는 구조",
    safePhrasing: "그런 과속의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 겁재는 겨루는 기운. 이기려는 동안 소모를 못 느낀다.",
  },
  {
    id: "FAMILY-TG-GEOPJAE",
    priority: 72,
    when: { tenGodAny: ["겁재"], domains: ["gajok"] },
    claim: "형제·가족 사이 몫의 경계가 자주 걸리는 결 — 나눔의 선을 미리 그어야 편한 구조",
    safePhrasing: "그런 경계의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 겁재는 몫을 겨루는 별. 가족 안에서는 경계가 곧 평화다.",
  },
  {
    id: "MOVE-TG-GEOPJAE",
    priority: 72,
    when: { tenGodAny: ["겁재"], domains: ["isa"] },
    claim: "같이 사는 자리에서 마찰이 커지기 쉬운 결 — 공간을 나누는 규칙이 먼저인 구조",
    safePhrasing: "그런 분할의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 겁재는 부딪히는 기운. 한 공간에서는 선이 필요하다.",
  },
  {
    id: "HEALTH-TG-SIKSIN",
    priority: 72,
    when: { tenGodAny: ["식신"], domains: ["geongang"] },
    claim: "먹고 쉬는 것이 곧 회복인 결 — 끼니와 잠을 지키면 웬만한 소모는 돌아오는 구조",
    safePhrasing: "그런 양생의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 식신은 먹을 복과 양생의 별. 기르는 것이 지키는 것이다.",
  },
  {
    id: "FAMILY-TG-SIKSIN",
    priority: 72,
    when: { tenGodAny: ["식신"], domains: ["gajok"] },
    claim: "가족을 먹이고 돌보는 자리에 서는 결 — 주는 쪽이 익숙해 제 몫을 잊기 쉬운 구조",
    safePhrasing: "그런 돌봄의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 식신은 낳아 기르는 별. 가족 안에서는 돌보는 손이 된다.",
  },
  {
    id: "MOVE-TG-SIKSIN",
    priority: 72,
    when: { tenGodAny: ["식신"], domains: ["isa"] },
    claim: "머무는 자리를 살림으로 채우는 결 — 옮기기보다 지금 자리를 기르는 쪽이 맞는 구조",
    safePhrasing: "그런 가꿈의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 식신은 기르는 기운. 터도 길러서 제 것이 된다.",
  },
  {
    id: "HEALTH-TG-SANGGWAN",
    priority: 72,
    when: { tenGodAny: ["상관"], domains: ["geongang"] },
    claim: "기운을 밖으로 쏟아내는 결 — 말과 표현이 많은 날일수록 회복 시간을 따로 두는 구조",
    safePhrasing: "그런 발산의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 상관은 내쏘는 별. 쏟은 만큼 채워야 한다.",
  },
  {
    id: "FAMILY-TG-SANGGWAN",
    priority: 72,
    when: { tenGodAny: ["상관"], domains: ["gajok"] },
    claim: "집안 어른의 틀과 부딪히기 쉬운 결 — 맞서기보다 자리를 옮겨 말할 때 통하는 구조",
    safePhrasing: "그런 부딪힘의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 상관은 관을 상하게 하는 별. 가풍의 틀과 각을 세운다.",
  },
  {
    id: "MOVE-TG-SANGGWAN",
    priority: 72,
    when: { tenGodAny: ["상관"], domains: ["isa"] },
    claim: "답답하면 떠나고 싶어지는 결 — 옮기는 결정이 감정에서 오지 않게 한 박자 쉬는 구조",
    safePhrasing: "그런 충동의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 상관은 틀을 벗는 기운. 떠남이 답이 아닐 때를 가려야 한다.",
  },
  {
    id: "HEALTH-TG-PYEONJAE",
    priority: 72,
    when: { tenGodAny: ["편재"], domains: ["geongang"] },
    claim: "몸을 바삐 굴리는 결 — 활동이 곧 활력이지만 멈추는 법을 따로 배워야 하는 구조",
    safePhrasing: "그런 활동의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 편재는 천하를 도는 기운. 몸도 함께 돈다.",
  },
  {
    id: "FAMILY-TG-PYEONJAE",
    priority: 72,
    when: { tenGodAny: ["편재"], domains: ["gajok"] },
    claim: "아버지 자리와의 결이 짙은 명식 — 그 관계의 온도가 집안 전체의 온도가 되기 쉬운 구조",
    safePhrasing: "그런 부친 자리의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 육친 — 편재는 아버지의 별. 그 자리의 결이 크게 울린다.",
  },
  {
    id: "MOVE-TG-PYEONJAE",
    priority: 72,
    when: { tenGodAny: ["편재"], domains: ["isa"] },
    claim: "이동이 잦아도 지치지 않는 결 — 오히려 한 곳에 오래 묶이면 답답해지는 구조",
    safePhrasing: "그런 유동의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 편재는 유동의 별. 움직이는 자리에서 산다.",
  },
  {
    id: "HEALTH-TG-JEONGJAE",
    priority: 72,
    when: { tenGodAny: ["정재"], domains: ["geongang"] },
    claim: "규칙적인 관리가 통하는 결 — 정해진 리듬을 지킬 때 몸이 가장 순한 구조",
    safePhrasing: "그런 규칙의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 정재는 헤아려 지키는 기운. 몸도 살림처럼 관리된다.",
  },
  {
    id: "FAMILY-TG-JEONGJAE",
    priority: 72,
    when: { tenGodAny: ["정재"], domains: ["gajok"] },
    claim: "집안 살림을 지키는 자리에 서는 결 — 실무를 떠안기 쉬워 몫을 나누는 연습이 필요한 구조",
    safePhrasing: "그런 살림의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 정재는 지키는 별. 가족 안에서 곳간을 맡는다.",
  },
  {
    id: "MOVE-TG-JEONGJAE",
    priority: 72,
    when: { tenGodAny: ["정재"], domains: ["isa"] },
    claim: "한 곳에 뿌리내리는 결 — 자주 옮기면 소모가 크고, 옮긴다면 오래 살 곳을 고르는 구조",
    safePhrasing: "그런 정주의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 정재는 내 손안의 것. 자리도 오래 쥘 것을 고른다.",
  },
  {
    id: "HEALTH-TG-PYEONGWAN",
    priority: 72,
    when: { tenGodAny: ["편관"], domains: ["geongang"] },
    claim: "몸을 몰아붙이는 결 — 견디는 힘이 좋아 신호를 무시하다 한 번에 크게 쉬게 되는 구조",
    safePhrasing: "그런 견딤의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 편관은 나를 치는 기운. 견딤이 미덕이자 함정이다.",
  },
  {
    id: "FAMILY-TG-PYEONGWAN",
    priority: 72,
    when: { tenGodAny: ["편관"], domains: ["gajok"] },
    claim: "집안의 무게를 지는 자리에 서는 결 — 책임이 몰리기 쉬워 나눠 지는 법이 관건인 구조",
    safePhrasing: "그런 짐의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 편관은 무게다. 가족 안에서는 기둥 노릇이 된다.",
  },
  {
    id: "MOVE-TG-PYEONGWAN",
    priority: 72,
    when: { tenGodAny: ["편관"], domains: ["isa"] },
    claim: "일 따라 움직이는 이동의 결 — 옮김이 선택보다 부름으로 오는 구조",
    safePhrasing: "그런 부름의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 편관은 밖에서 오는 압력. 이동도 그 힘으로 온다.",
  },
  {
    id: "HEALTH-TG-JEONGGWAN",
    priority: 72,
    when: { tenGodAny: ["정관"], domains: ["geongang"] },
    claim: "절제가 몸에 밴 결 — 규율이 있는 생활에서 리듬이 서고 흐트러지면 크게 무너지는 구조",
    safePhrasing: "그런 절제의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 정관은 법도의 별. 규율이 곧 건강의 틀이 된다.",
  },
  {
    id: "FAMILY-TG-JEONGGWAN",
    priority: 72,
    when: { tenGodAny: ["정관"], domains: ["gajok"] },
    claim: "가풍·규범과 결이 맞는 편 — 다만 틀을 지키느라 제 목소리를 미루기 쉬운 구조",
    safePhrasing: "그런 법도의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 통설 — 정관은 바른 규율. 집안의 틀과 순하게 만난다.",
  },
  {
    id: "MOVE-TG-JEONGGWAN",
    priority: 72,
    when: { tenGodAny: ["정관"], domains: ["isa"] },
    claim: "안정된 정주의 결 — 옮기더라도 절차와 계획이 선 이동이어야 편한 구조",
    safePhrasing: "그런 계획 이동의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 정관은 질서의 별. 이동에도 순서가 있어야 한다.",
  },
  {
    id: "HEALTH-TG-PYEONIN",
    priority: 72,
    when: { tenGodAny: ["편인"], domains: ["geongang"] },
    claim: "먹고 자는 리듬이 불규칙해지기 쉬운 결 — 끼니와 잠을 고정하는 것이 가장 큰 처방인 구조",
    safePhrasing: "그런 불규칙의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 편인도식. 편인이 식신을 극해 먹고 쉬는 복을 건드린다.",
  },
  {
    id: "FAMILY-TG-PYEONIN",
    priority: 72,
    when: { tenGodAny: ["편인"], domains: ["gajok"] },
    claim: "어머니에게서 받은 것이 남다른 결 — 애정의 표현 방식이 독특해 오해가 쌓이기 쉬운 구조",
    safePhrasing: "그런 독특한 정의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 육친 — 편인은 치우친 인성. 어머니 자리의 결이 별나게 온다.",
  },
  {
    id: "MOVE-TG-PYEONIN",
    priority: 72,
    when: { tenGodAny: ["편인"], domains: ["isa"] },
    claim: "낯선 곳에 빨리 적응하는 결 — 다만 정 붙이기 전에 또 옮기고 싶어지는 구조",
    safePhrasing: "그런 적응의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 편인은 별식의 기운. 낯섦이 오히려 편하다.",
  },
  {
    id: "HEALTH-TG-JEONGIN",
    priority: 72,
    when: { tenGodAny: ["정인"], domains: ["geongang"] },
    claim: "회복이 느긋하게 되는 결 — 급히 채우기보다 푹 쉬는 하루가 약이 되는 구조",
    safePhrasing: "그런 느긋한 회복의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "십신 통설 — 정인은 받아 채우는 별. 회복도 받아들이듯 온다.",
  },
  {
    id: "FAMILY-TG-JEONGIN",
    priority: 72,
    when: { tenGodAny: ["정인"], domains: ["gajok"] },
    claim: "어머니의 자애가 짙은 자리 — 받은 것이 커서 기대와 부담이 함께 오는 구조",
    safePhrasing: "그런 자애의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "십신 육친 — 정인은 어머니의 별. 받은 만큼의 무게가 있다.",
  },
  {
    id: "MOVE-TG-JEONGIN",
    priority: 72,
    when: { tenGodAny: ["정인"], domains: ["isa"] },
    claim: "집이 곧 안식처인 결 — 옮기는 일 자체가 큰 소모라 준비 기간을 길게 잡는 구조",
    safePhrasing: "그런 안식처의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "십신 통설 — 정인은 품는 기운. 터는 곧 품이다.",
  },
  {
    id: "HEALTH-DM-WOOD",
    priority: 80,
    when: { dayMasterElement: ["목"], domains: ["geongang"] },
    claim: "봄에 오르고 가을에 꺾이는 기운의 결 — 뻗는 철에 벌이고 거두는 철에 아끼는 구조",
    safePhrasing: "그런 봄의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 성정 — 木은 봄의 기운. 자라는 철에 살고 거두는 철에 쉰다.",
  },
  {
    id: "FAMILY-DM-WOOD",
    priority: 80,
    when: { dayMasterElement: ["목"], domains: ["gajok"] },
    claim: "가족을 자라게 하는 정의 결 — 돌보고 키우는 쪽으로 마음이 먼저 가는 구조",
    safePhrasing: "그런 키움의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 성정 — 木은 기르는 기운. 정도 자라게 하는 쪽으로 쓴다.",
  },
  {
    id: "MOVE-DM-WOOD",
    priority: 80,
    when: { dayMasterElement: ["목"], domains: ["isa"] },
    claim: "볕과 바람이 드는 터에서 사는 결 — 막힌 공간에서 유난히 갑갑해지는 구조",
    safePhrasing: "그런 볕의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 성정 — 木은 위로 자란다. 터도 자랄 틈이 있어야 한다.",
  },
  {
    id: "HEALTH-DM-FIRE",
    priority: 80,
    when: { dayMasterElement: ["화"], domains: ["geongang"] },
    claim: "낮에 타오르고 밤에 꺼지는 기운의 결 — 밤을 세우면 배로 갚는 구조",
    safePhrasing: "그런 낮의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 성정 — 火는 한낮의 기운. 타는 시간과 꺼지는 시간이 뚜렷하다.",
  },
  {
    id: "FAMILY-DM-FIRE",
    priority: 80,
    when: { dayMasterElement: ["화"], domains: ["gajok"] },
    claim: "정을 내색으로 쓰는 결 — 표현이 닿지 않으면 서운함이 빨리 쌓이는 구조",
    safePhrasing: "그런 내색의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 성정 — 火는 드러나는 기운. 정도 보여야 전해진다.",
  },
  {
    id: "MOVE-DM-FIRE",
    priority: 80,
    when: { dayMasterElement: ["화"], domains: ["isa"] },
    claim: "드러나는 자리에서 사는 결 — 어둡고 습한 공간에서 기운이 눅는 구조",
    safePhrasing: "그런 밝음의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 성정 — 火는 밝음에서 산다. 터도 빛이 먼저다.",
  },
  {
    id: "HEALTH-DM-EARTH",
    priority: 80,
    when: { dayMasterElement: ["토"], domains: ["geongang"] },
    claim: "환절기에 처지기 쉬운 기운의 결 — 계절이 바뀌는 길목마다 미리 쉬어 두는 구조",
    safePhrasing: "그런 길목의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 성정 — 土는 계절의 사이를 받친다. 환절의 무게가 먼저 얹힌다.",
  },
  {
    id: "FAMILY-DM-EARTH",
    priority: 80,
    when: { dayMasterElement: ["토"], domains: ["gajok"] },
    claim: "가운데서 받치는 정의 결 — 가족 사이 중재를 떠맡기 쉬운 구조",
    safePhrasing: "그런 중재의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 성정 — 土는 가운데의 기운. 사이를 받치는 자리에 선다.",
  },
  {
    id: "MOVE-DM-EARTH",
    priority: 80,
    when: { dayMasterElement: ["토"], domains: ["isa"] },
    claim: "눌러앉을수록 단단해지는 결 — 옮김 자체보다 옮긴 뒤의 정착이 관건인 구조",
    safePhrasing: "그런 정착의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 성정 — 土는 쌓여야 단단하다. 터도 시간이 만든다.",
  },
  {
    id: "HEALTH-DM-METAL",
    priority: 80,
    when: { dayMasterElement: ["금"], domains: ["geongang"] },
    claim: "건조한 철에 민감한 기운의 결 — 마른 계절에 목을 축이고 쉼을 당기는 구조",
    safePhrasing: "그런 가을의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 성정 — 金은 가을의 기운. 마름에 예민하고 서늘함에 선다.",
  },
  {
    id: "FAMILY-DM-METAL",
    priority: 80,
    when: { dayMasterElement: ["금"], domains: ["gajok"] },
    claim: "정에도 선이 있는 결 — 거리가 지켜질 때 오히려 오래 가는 구조",
    safePhrasing: "그런 거리의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 성정 — 金은 가르는 기운. 정도 경계 위에서 맑아진다.",
  },
  {
    id: "MOVE-DM-METAL",
    priority: 80,
    when: { dayMasterElement: ["금"], domains: ["isa"] },
    claim: "정돈된 공간이어야 쉬어지는 결 — 어수선한 터에서 기운이 계속 새는 구조",
    safePhrasing: "그런 정돈의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 성정 — 金은 벼려진 기운. 공간의 날이 서야 마음이 놓인다.",
  },
  {
    id: "HEALTH-DM-WATER",
    priority: 80,
    when: { dayMasterElement: ["수"], domains: ["geongang"] },
    claim: "겨울에 깊어지는 기운의 결 — 추운 철에 웅크림이 오히려 회복이 되는 구조",
    safePhrasing: "그런 겨울의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 성정 — 水는 겨울의 기운. 깊이 고이는 철이 채우는 철이다.",
  },
  {
    id: "FAMILY-DM-WATER",
    priority: 80,
    when: { dayMasterElement: ["수"], domains: ["gajok"] },
    claim: "말없이 스며드는 정의 결 — 표현이 적어 오해받기 쉽지만 오래 젖는 구조",
    safePhrasing: "그런 스밈의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 성정 — 水는 스며드는 기운. 정도 소리 없이 깊다.",
  },
  {
    id: "MOVE-DM-WATER",
    priority: 80,
    when: { dayMasterElement: ["수"], domains: ["isa"] },
    claim: "물길처럼 옮겨 다녀도 유연한 결 — 다만 고일 자리 하나는 정해 두는 구조",
    safePhrasing: "그런 유연함의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 성정 — 水는 흐르며 산다. 흐름에도 웅덩이가 필요하다.",
  },
  {
    id: "HEALTH-STR-STRONG",
    priority: 76,
    when: { strength: ["신강"], domains: ["geongang"] },
    claim: "버티는 힘이 좋은 그릇 — 신호를 무시해도 당장은 서지만 몰아서 갚게 되는 구조",
    safePhrasing: "그런 버팀의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "강약 통설 — 신강은 기운이 남는 명식. 견딤이 길어 경고가 늦게 온다.",
  },
  {
    id: "FAMILY-STR-STRONG",
    priority: 76,
    when: { strength: ["신강"], domains: ["gajok"] },
    claim: "가족 안에서 제 뜻이 또렷한 그릇 — 물러서는 법을 챙겨야 부딪힘이 줄어드는 구조",
    safePhrasing: "그런 또렷함의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "강약 통설 — 신강은 중심이 굳다. 가족 안에서는 유연이 과제다.",
  },
  {
    id: "MOVE-STR-STRONG",
    priority: 76,
    when: { strength: ["신강"], domains: ["isa"] },
    claim: "옮겨도 흔들리지 않는 그릇 — 새 터에 빨리 서는 구조",
    safePhrasing: "그런 뿌리 힘의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "강약 통설 — 신강은 뿌리가 깊다. 옮겨 심어도 산다.",
  },
  {
    id: "HEALTH-STR-WEAK",
    priority: 76,
    when: { strength: ["신약"], domains: ["geongang"] },
    claim: "소모에 예민한 그릇 — 무리의 값을 바로 치르므로 아끼는 운용이 곧 체력인 구조",
    safePhrasing: "그런 아낌의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "강약 통설 — 신약은 기운이 밭다. 배분이 곧 건강이다.",
  },
  {
    id: "FAMILY-STR-WEAK",
    priority: 76,
    when: { strength: ["신약"], domains: ["gajok"] },
    claim: "가족의 기류에 쉽게 물드는 그릇 — 거리 조절이 곧 자기 보호인 구조",
    safePhrasing: "그런 물듦의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "강약 통설 — 신약은 바깥 기운에 눌린다. 가까운 사이일수록 거리가 약이다.",
  },
  {
    id: "MOVE-STR-WEAK",
    priority: 76,
    when: { strength: ["신약"], domains: ["isa"] },
    claim: "옮기는 일이 큰 소모인 그릇 — 이동을 잘게 나눠 치르는 것이 맞는 구조",
    safePhrasing: "그런 분할 이동의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "강약 통설 — 신약은 큰 짐에 눌린다. 이사도 나눠 지면 가볍다.",
  },
  {
    id: "HEALTH-STR-BALANCED",
    priority: 76,
    when: { strength: ["중화"], domains: ["geongang"] },
    claim: "무리만 없으면 꾸준한 그릇 — 극단을 피하는 것만으로 리듬이 유지되는 구조",
    safePhrasing: "그런 항상성의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "강약 통설 — 중화는 치우침이 적다. 유지가 곧 관리다.",
  },
  {
    id: "FAMILY-STR-BALANCED",
    priority: 76,
    when: { strength: ["중화"], domains: ["gajok"] },
    claim: "가족 사이 어디에도 설 수 있는 그릇 — 역할을 바꿔 가며 균형을 잡는 구조",
    safePhrasing: "그런 균형의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "강약 통설 — 중화는 균형의 명식. 자리를 옮겨 다니며 받친다.",
  },
  {
    id: "MOVE-STR-BALANCED",
    priority: 76,
    when: { strength: ["중화"], domains: ["isa"] },
    claim: "머물러도 옮겨도 무너지지 않는 그릇 — 시기만 맞으면 어느 쪽도 되는 구조",
    safePhrasing: "그런 양용의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "강약 통설 — 중화는 형태를 바꾼다. 결정의 무게가 가볍다.",
  },
  {
    id: "HEALTH-SS-YEOKMA",
    priority: 62,
    when: { shinsal: ["역마"], domains: ["geongang"] },
    claim: "몸이 이동에서 풀리는 별 — 걷고 오가는 것이 쉼이 되는 구조",
    safePhrasing: "그런 이동 회복의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "신살 통설 — 역마는 움직임의 별. 멈추면 오히려 고인다.",
  },
  {
    id: "FAMILY-SS-YEOKMA",
    priority: 62,
    when: { shinsal: ["역마"], domains: ["gajok"] },
    claim: "가족과 떨어져 지내는 시간이 있는 별 — 거리가 정을 상하게 하지 않는 구조",
    safePhrasing: "그런 원거리의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "신살 통설 — 역마는 떠나는 별. 멀어짐이 끊어짐은 아니다.",
  },
  {
    id: "MOVE-SS-YEOKMA",
    priority: 62,
    when: { shinsal: ["역마"], domains: ["isa"] },
    claim: "이동수가 명식에 앉은 별 — 옮기는 흐름이 삶에 여러 번 오는 구조",
    safePhrasing: "그런 이동수의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "신살 통설 — 역마는 삼합 생지를 충하는 이동의 별.",
  },
  {
    id: "HEALTH-SS-HWAGAE",
    priority: 62,
    when: { shinsal: ["화개"], domains: ["geongang"] },
    claim: "혼자 고요히 있을 때 채워지는 별 — 회복에 반드시 혼자의 시간이 필요한 구조",
    safePhrasing: "그런 고요의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "신살 통설 — 화개는 거두어 덮는 별. 홀로 갈무리하며 채운다.",
  },
  {
    id: "FAMILY-SS-HWAGAE",
    priority: 62,
    when: { shinsal: ["화개"], domains: ["gajok"] },
    claim: "가족 안에서도 제 방이 필요한 별 — 물러날 공간이 있어야 정이 유지되는 구조",
    safePhrasing: "그런 제 방의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "신살 통설 — 화개는 덮고 물러나는 별. 물러남이 관계를 지킨다.",
  },
  {
    id: "MOVE-SS-HWAGAE",
    priority: 62,
    when: { shinsal: ["화개"], domains: ["isa"] },
    claim: "터에서 고요한 구석을 찾는 별 — 집 안에 갈무리의 자리 하나가 꼭 필요한 구조",
    safePhrasing: "그런 구석의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "신살 통설 — 화개는 고지의 별. 거두는 자리가 있어야 산다.",
  },
  {
    id: "HEALTH-SS-YANGIN",
    priority: 62,
    when: { shinsal: ["양인"], domains: ["geongang"] },
    claim: "한 번에 크게 태우는 별 — 폭발 뒤의 공백을 미리 계산에 넣어야 하는 구조",
    safePhrasing: "그런 폭발의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "신살 통설 — 양인은 날 선 기운. 크게 쓰고 크게 쉰다.",
  },
  {
    id: "FAMILY-SS-YANGIN",
    priority: 62,
    when: { shinsal: ["양인"], domains: ["gajok"] },
    claim: "가족 안에서 말이 날로 서기 쉬운 별 — 아끼는 마음일수록 칼집에 넣어 말하는 구조",
    safePhrasing: "그런 날의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "신살 통설 — 양인은 날이 선 별. 가까운 사이에서 더 조심해야 한다.",
  },
  {
    id: "MOVE-SS-YANGIN",
    priority: 62,
    when: { shinsal: ["양인"], domains: ["isa"] },
    claim: "단칼에 옮기는 별 — 결정은 빠르되 뒷정리를 남에게 맡기지 않는 구조",
    safePhrasing: "그런 단행의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "신살 통설 — 양인은 과단의 별. 벤 자리는 스스로 여며야 한다.",
  },
  {
    id: "HEALTH-MISS-WOOD",
    priority: 66,
    when: { missingElement: ["목"], domains: ["geongang"] },
    claim: "명식에 木이 비어 새 기운을 틔우는 힘이 밭은 결 — 아침 산책·초록 곁에 두기처럼 자라는 기운을 밖에서 빌리는 구조",
    safePhrasing: "그런 빌림의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 결핍 통설 — 木 부재는 생발의 결핍. 자라는 것 곁에서 빌린다.",
  },
  {
    id: "FAMILY-MISS-WOOD",
    priority: 66,
    when: { missingElement: ["목"], domains: ["gajok"] },
    claim: "명식에 木이 비어 정을 키워 가는 결이 밭은 편 — 관계를 기르는 일을 의식적으로 챙기는 구조",
    safePhrasing: "그런 의식적 돌봄의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 결핍 통설 — 木 부재는 기름의 결핍. 정도 일정으로 챙긴다.",
  },
  {
    id: "MOVE-MISS-WOOD",
    priority: 66,
    when: { missingElement: ["목"], domains: ["isa"] },
    claim: "명식에 木이 비어 새 터를 틔우는 힘이 밭은 결 — 옮긴 뒤 자리 잡는 의식(한 그루 화분이라도)을 두는 구조",
    safePhrasing: "그런 틔움의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 결핍 통설 — 木 부재는 발아의 결핍. 심는 행위가 정착을 돕는다.",
  },
  {
    id: "HEALTH-MISS-FIRE",
    priority: 66,
    when: { missingElement: ["화"], domains: ["geongang"] },
    claim: "명식에 火가 비어 데우는 힘이 밭은 결 — 몸을 차게 두지 않는 것이 기본 관리인 구조",
    safePhrasing: "그런 보온의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 결핍 통설 — 火 부재는 온기의 결핍. 데움을 습관으로 만든다.",
  },
  {
    id: "FAMILY-MISS-FIRE",
    priority: 66,
    when: { missingElement: ["화"], domains: ["gajok"] },
    claim: "명식에 火가 비어 내색이 밭은 결 — 표현하지 않은 정은 없는 정으로 읽힌다는 걸 기억하는 구조",
    safePhrasing: "그런 표현 연습의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 결핍 통설 — 火 부재는 발산의 결핍. 정은 말로 옮겨야 닿는다.",
  },
  {
    id: "MOVE-MISS-FIRE",
    priority: 66,
    when: { missingElement: ["화"], domains: ["isa"] },
    claim: "명식에 火가 비어 공간을 데우는 기운이 밭은 결 — 조명과 볕이 좋은 터가 남보다 크게 작용하는 구조",
    safePhrasing: "그런 채광의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 결핍 통설 — 火 부재는 밝음의 결핍. 터의 빛으로 채운다.",
  },
  {
    id: "HEALTH-MISS-EARTH",
    priority: 66,
    when: { missingElement: ["토"], domains: ["geongang"] },
    claim: "명식에 土가 비어 눌러앉는 힘이 밭은 결 — 끼니 시간을 고정하는 것부터가 관리인 구조",
    safePhrasing: "그런 고정의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 결핍 통설 — 土 부재는 안정의 결핍. 시간을 붙박아 보완한다.",
  },
  {
    id: "FAMILY-MISS-EARTH",
    priority: 66,
    when: { missingElement: ["토"], domains: ["gajok"] },
    claim: "명식에 土가 비어 가운데를 받치는 힘이 밭은 결 — 중재를 떠맡기보다 자리를 지키는 쪽이 맞는 구조",
    safePhrasing: "그런 제자리의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 결핍 통설 — 土 부재는 중심의 결핍. 받치는 역할은 나눠 진다.",
  },
  {
    id: "MOVE-MISS-EARTH",
    priority: 66,
    when: { missingElement: ["토"], domains: ["isa"] },
    claim: "명식에 土가 비어 정착의 힘이 밭은 결 — 옮긴 뒤 최소 한 계절은 자리에 시간을 주는 구조",
    safePhrasing: "그런 계절의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 결핍 통설 — 土 부재는 정착의 결핍. 시간이 흙을 대신한다.",
  },
  {
    id: "HEALTH-MISS-METAL",
    priority: 66,
    when: { missingElement: ["금"], domains: ["geongang"] },
    claim: "명식에 金이 비어 끊는 힘이 밭은 결 — 쉼의 시각을 미리 정해 두어야 멈춰지는 구조",
    safePhrasing: "그런 마감의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 결핍 통설 — 金 부재는 결단의 결핍. 멈춤을 약속으로 만든다.",
  },
  {
    id: "FAMILY-MISS-METAL",
    priority: 66,
    when: { missingElement: ["금"], domains: ["gajok"] },
    claim: "명식에 金이 비어 선을 긋는 힘이 밭은 결 — 거절을 문장으로 미리 만들어 두는 구조",
    safePhrasing: "그런 준비된 선의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 결핍 통설 — 金 부재는 경계의 결핍. 선은 미리 벼려 둔다.",
  },
  {
    id: "MOVE-MISS-METAL",
    priority: 66,
    when: { missingElement: ["금"], domains: ["isa"] },
    claim: "명식에 金이 비어 정리하는 힘이 밭은 결 — 옮기기 전 버리는 일을 먼저 끝내는 구조",
    safePhrasing: "그런 선정리의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 결핍 통설 — 金 부재는 추림의 결핍. 버림이 이사의 반이다.",
  },
  {
    id: "HEALTH-MISS-WATER",
    priority: 66,
    when: { missingElement: ["수"], domains: ["geongang"] },
    claim: "명식에 水가 비어 식히는 힘이 밭은 결 — 달아오른 날 스스로 못 식히므로 물가·밤 산책 같은 장치를 두는 구조",
    safePhrasing: "그런 냉각 장치의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "오행 결핍 통설 — 水 부재는 식힘의 결핍. 물의 자리를 빌린다.",
  },
  {
    id: "FAMILY-MISS-WATER",
    priority: 66,
    when: { missingElement: ["수"], domains: ["gajok"] },
    claim: "명식에 水가 비어 스며드는 정이 밭은 결 — 깊은 대화의 자리를 따로 만들어야 닿는 구조",
    safePhrasing: "그런 자리 마련의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "오행 결핍 통설 — 水 부재는 스밈의 결핍. 깊이는 시간을 정해 판다.",
  },
  {
    id: "MOVE-MISS-WATER",
    priority: 66,
    when: { missingElement: ["수"], domains: ["isa"] },
    claim: "명식에 水가 비어 흐름을 읽는 힘이 밭은 결 — 시세·시기 판단을 감이 아니라 기록으로 하는 구조",
    safePhrasing: "그런 기록의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "오행 결핍 통설 — 水 부재는 흐름의 결핍. 정보가 물길을 대신한다.",
  },
  {
    id: "HEALTH-REL-CLASH",
    priority: 58,
    when: { relationKind: ["지지충"], domains: ["geongang"] },
    claim: "명식 안의 충이 리듬을 흔드는 이벤트로 오는 결 — 크게 무너진 날 자책보다 회복 절차를 미리 정해 두는 구조",
    safePhrasing: "그런 복구 절차의 결",
    forbidden: ["병이 온다", "아프게 된다"],
    source: "합충 통설 — 지지충은 부딪히는 사건. 몸에서는 리듬의 단절로 나타난다.",
  },
  {
    id: "FAMILY-REL-CLASH",
    priority: 58,
    when: { relationKind: ["지지충"], domains: ["gajok"] },
    claim: "명식 안의 충이 가족 자리의 흔들림으로 오는 결 — 큰 명절·경조사처럼 모이는 자리에서 소모가 커지기 쉬운 구조",
    safePhrasing: "그런 모임 소모의 결",
    forbidden: ["부모 복이 없다", "인연을 끊어야 한다"],
    source: "합충 통설 — 지지충은 자리가 부딪히는 사건. 가족에서는 모임의 마찰로 나타난다.",
  },
  {
    id: "MOVE-REL-CLASH",
    priority: 58,
    when: { relationKind: ["지지충"], domains: ["isa"] },
    claim: "명식 안의 충이 자리를 흔드는 이벤트로 오는 결 — 이동이 계획보다 사건으로 오기 쉬워 여유분을 두는 구조",
    safePhrasing: "그런 대비의 결",
    forbidden: ["이사하면 반드시 잘 풀린다", "그 집에 살면 화를 입는다"],
    source: "합충 통설 — 지지충은 부딪혀 움직이는 사건. 터에서는 갑작스런 이동으로 나타난다.",
  },

  // ── 직장 인간관계 (jikjang) — 일터에서 사람을 만나는 결 ──────
  {
    id: "OFFICE-TG-BIGYEON",
    priority: 72,
    when: { tenGodAny: ["비견"], domains: ["jikjang"] },
    claim: "동료와 어깨를 나란히 하는 결 — 대등한 자리에서 힘이 나고 위계가 좁으면 갑갑해지기 쉬운 구조",
    safePhrasing: "그런 동료의 결",
    forbidden: ["상사와는 반드시 부딪힌다"],
    source: "십신 통설 — 비견은 어깨동무의 별. 대등할 때 순하다.",
  },
  {
    id: "OFFICE-TG-GEOPJAE",
    priority: 72,
    when: { tenGodAny: ["겁재"], domains: ["jikjang"] },
    claim: "승부가 걸리면 살아나는 결 — 경쟁 구도에서 힘이 나되 내 몫의 경계를 먼저 긋는 것이 편해지는 길인 구조",
    safePhrasing: "그런 승부의 결",
    forbidden: ["동료가 반드시 내 것을 빼앗는다"],
    source: "십신 통설 — 겁재는 겨루는 별. 몫의 경계가 관건이다.",
  },
  {
    id: "OFFICE-TG-SIKSIN",
    priority: 72,
    when: { tenGodAny: ["식신"], domains: ["jikjang"] },
    claim: "곁을 편하게 풀어 주는 결 — 딱딱한 위계보다 느슨한 자리에서 신뢰가 쌓이는 구조",
    safePhrasing: "그런 융화의 결",
    forbidden: ["모두에게 반드시 사랑받는다"],
    source: "십신 통설 — 식신은 베푸는 별. 곁을 부드럽게 한다.",
  },
  {
    id: "OFFICE-TG-SANGGWAN",
    priority: 72,
    when: { tenGodAny: ["상관"], domains: ["jikjang"] },
    claim: "바른말이 먼저 나가는 결 — 틀린 지시 앞에서 참기 어려워 말의 순서를 다듬는 것이 관계의 기술이 되는 구조",
    safePhrasing: "그런 직언의 결",
    forbidden: ["상사에게 반드시 미움받는다"],
    source: "십신 통설 — 상관은 관을 건드리는 말의 별. 날이 서면 위를 친다.",
  },
  {
    id: "OFFICE-TG-PYEONJAE",
    priority: 72,
    when: { tenGodAny: ["편재"], domains: ["jikjang"] },
    claim: "두루 넓게 사귀는 결 — 부서 밖까지 발이 넓되 깊이는 몇에게만 두는 것이 편한 구조",
    safePhrasing: "그런 마당발의 결",
    forbidden: ["인맥으로 반드시 성공한다"],
    source: "십신 통설 — 편재는 넓게 굴리는 별. 관계도 넓게 편다.",
  },
  {
    id: "OFFICE-TG-JEONGJAE",
    priority: 72,
    when: { tenGodAny: ["정재"], domains: ["jikjang"] },
    claim: "맡은 몫으로 신뢰를 쌓는 결 — 화려한 말보다 꾸준한 마무리로 곁의 믿음이 굳는 구조",
    safePhrasing: "그런 신용의 결",
    forbidden: ["융통성이 없어 반드시 손해 본다"],
    source: "십신 통설 — 정재는 착실한 별. 갚을 것을 갚으며 관계가 쌓인다.",
  },
  {
    id: "OFFICE-TG-PYEONGWAN",
    priority: 72,
    when: { tenGodAny: ["편관"], domains: ["jikjang"] },
    claim: "위계의 긴장을 정면으로 받는 결 — 압박 아래에서 기강이 서되 그만큼 소모도 커서 회복 자리가 필요한 구조",
    safePhrasing: "그런 기강의 결",
    forbidden: ["윗사람 운이 반드시 나쁘다"],
    source: "십신 통설 — 편관은 누르는 힘. 견디는 만큼 단단해진다.",
  },
  {
    id: "OFFICE-TG-JEONGGWAN",
    priority: 72,
    when: { tenGodAny: ["정관"], domains: ["jikjang"] },
    claim: "역할과 예의로 만나는 결 — 선이 분명한 관계에서 편하고 선을 넘는 사람 앞에서 굳는 구조",
    safePhrasing: "그런 법도의 결",
    forbidden: ["사적으로는 반드시 어울리지 못한다"],
    source: "십신 통설 — 정관은 바른 규율. 관계에도 자리와 순서를 둔다.",
  },
  {
    id: "OFFICE-TG-PYEONIN",
    priority: 72,
    when: { tenGodAny: ["편인"], domains: ["jikjang"] },
    claim: "한 걸음 물러나 읽는 결 — 무리에 섞이기보다 관찰이 먼저라 곁을 트기까지 시간이 걸리는 구조",
    safePhrasing: "그런 관망의 결",
    forbidden: ["조직에서 반드시 겉돈다"],
    source: "십신 통설 — 편인은 비껴 읽는 별. 거리에서 통찰이 나온다.",
  },
  {
    id: "OFFICE-TG-JEONGIN",
    priority: 72,
    when: { tenGodAny: ["정인"], domains: ["jikjang"] },
    claim: "배우고 배워 주며 가까워지는 결 — 가르침이 오가는 관계에서 결이 살고 윗사람의 인정이 힘이 되는 구조",
    safePhrasing: "그런 사수의 결",
    forbidden: ["윗사람에게 반드시 예쁨받는다"],
    source: "십신 통설 — 정인은 받아 주는 별. 위에서 오는 온기가 크다.",
  },
  {
    id: "OFFICE-DM-WOOD",
    priority: 80,
    when: { dayMasterElement: ["목"], domains: ["jikjang"] },
    claim: "곧게 뻗는 관계의 결 — 굽히는 말보다 바로 하는 말이 편해, 굽이를 배우면 곁이 넓어지는 구조",
    safePhrasing: "그런 곧은 결",
    forbidden: ["이 기질이라 관계가 반드시 좋다", "이 기질이라 관계가 반드시 나쁘다"],
    source: "오행 성정 — 木은 곧게 자란다. 굽는 법이 과제다.",
  },
  {
    id: "OFFICE-DM-FIRE",
    priority: 80,
    when: { dayMasterElement: ["화"], domains: ["jikjang"] },
    claim: "먼저 데우는 관계의 결 — 분위기를 밝히고 끌어올리되 식을 때의 낙차도 눈에 띄는 구조",
    safePhrasing: "그런 온기의 결",
    forbidden: ["이 기질이라 관계가 반드시 좋다", "이 기질이라 관계가 반드시 나쁘다"],
    source: "오행 성정 — 火는 번지고 밝힌다. 꺼짐도 눈에 띈다.",
  },
  {
    id: "OFFICE-DM-EARTH",
    priority: 80,
    when: { dayMasterElement: ["토"], domains: ["jikjang"] },
    claim: "가운데서 받아 주는 결 — 이 사람 저 사람의 말이 모여들어 중재가 일이 되기 쉬운 구조",
    safePhrasing: "그런 중심의 결",
    forbidden: ["이 기질이라 관계가 반드시 좋다", "이 기질이라 관계가 반드시 나쁘다"],
    source: "오행 성정 — 土는 가운데 자리. 오는 것을 받아 안는다.",
  },
  {
    id: "OFFICE-DM-METAL",
    priority: 80,
    when: { dayMasterElement: ["금"], domains: ["jikjang"] },
    claim: "선을 긋고 지키는 결 — 공과 사가 분명해 믿음직하되 차갑게 읽히기 쉬운 구조",
    safePhrasing: "그런 절도의 결",
    forbidden: ["이 기질이라 관계가 반드시 좋다", "이 기질이라 관계가 반드시 나쁘다"],
    source: "오행 성정 — 金은 가르고 벼린다. 맺고 끊음이 분명하다.",
  },
  {
    id: "OFFICE-DM-WATER",
    priority: 80,
    when: { dayMasterElement: ["수"], domains: ["jikjang"] },
    claim: "스며들어 맞추는 결 — 어느 팀에 놓여도 모나지 않게 섞이되 속은 잘 내보이지 않는 구조",
    safePhrasing: "그런 유연의 결",
    forbidden: ["이 기질이라 관계가 반드시 좋다", "이 기질이라 관계가 반드시 나쁘다"],
    source: "오행 성정 — 水는 그릇 따라 모양을 바꾼다. 속은 깊다.",
  },
  {
    id: "OFFICE-STR-STRONG",
    priority: 76,
    when: { strength: ["신강"], domains: ["jikjang"] },
    claim: "부딪혀도 중심이 밀리지 않는 그릇 — 센 사람 앞에서도 제 말이 나가되 세게 읽히기 쉬운 구조",
    safePhrasing: "그런 뚝심의 결",
    forbidden: ["그릇이 작아 관계를 버티지 못한다"],
    source: "강약 통설 — 신강은 일간이 뿌리내린 명식. 맞서도 흔들림이 적다.",
  },
  {
    id: "OFFICE-STR-WEAK",
    priority: 76,
    when: { strength: ["신약"], domains: ["jikjang"] },
    claim: "곁의 기운을 크게 받는 그릇 — 좋은 사람 곁에서 크게 살고 소모적인 사람 곁에서 빨리 닳는 구조",
    safePhrasing: "그런 감응의 결",
    forbidden: ["그릇이 작아 관계를 버티지 못한다"],
    source: "강약 통설 — 신약은 기대어 크는 명식. 곁이 절반이다.",
  },
  {
    id: "OFFICE-STR-BALANCED",
    priority: 76,
    when: { strength: ["중화"], domains: ["jikjang"] },
    claim: "맞춤과 버팀을 오가는 그릇 — 상대에 따라 세기를 조절할 줄 아는 균형이 무기인 구조",
    safePhrasing: "그런 균형의 결",
    forbidden: ["그릇이 작아 관계를 버티지 못한다"],
    source: "강약 통설 — 중화는 치우침이 적은 명식. 조절이 능하다.",
  },
  {
    id: "OFFICE-SS-YEOKMA",
    priority: 62,
    when: { shinsal: ["역마"], domains: ["jikjang"] },
    claim: "사람도 자리도 오래 고이지 않는 별 — 팀이 바뀌며 관계가 넓어지되 한 곳의 깊이는 따로 챙겨야 하는 구조",
    safePhrasing: "그런 이동의 결",
    forbidden: ["한 직장에 반드시 붙어 있지 못한다"],
    source: "신살 통설 — 역마는 움직이는 별. 관계도 길 위에서 만난다.",
  },
  {
    id: "OFFICE-SS-HWAGAE",
    priority: 62,
    when: { shinsal: ["화개"], domains: ["jikjang"] },
    claim: "홀로 고이는 시간이 필요한 별 — 회식보다 제 자리의 몰입이 회복이라 거리 두기가 무례가 아닌 구조",
    safePhrasing: "그런 몰입의 결",
    forbidden: ["살이 있어 반드시 외톨이가 된다"],
    source: "신살 통설 — 화개는 삼합의 고지. 고요에서 차오른다.",
  },
  {
    id: "OFFICE-SS-YANGIN",
    priority: 62,
    when: { shinsal: ["양인"], domains: ["jikjang"] },
    claim: "날 선 힘이 실리는 별 — 위기와 수습의 국면에서 빛나되 평시에는 세기를 줄여 쓰는 것이 기술인 구조",
    safePhrasing: "그런 벼림의 결",
    forbidden: ["살이 있어 반드시 크게 싸운다"],
    source: "신살 통설 — 양인은 날이 선 기운. 다루면 연장이 되고 놓치면 상처가 된다.",
  },
  {
    id: "OFFICE-MISS-WOOD",
    priority: 66,
    when: { missingElement: ["목"], domains: ["jikjang"] },
    claim: "명식에 木이 비어 먼저 손 내미는 기운이 밭은 결 — 관계의 시작을 의식해서 여는 구조",
    safePhrasing: "그런 시작 보완의 결",
    forbidden: ["없는 오행 탓에 반드시 갈등이 생긴다", "이 기운은 평생 채울 수 없다"],
    source: "오행 결핍 통설 — 木 부재는 뻗음의 결핍. 먼저 여는 일이 과제다.",
  },
  {
    id: "OFFICE-MISS-FIRE",
    priority: 66,
    when: { missingElement: ["화"], domains: ["jikjang"] },
    claim: "명식에 火가 비어 내 공을 밝혀 말하는 기운이 밭은 결 — 표현을 의식해서 채우는 구조",
    safePhrasing: "그런 표현 보완의 결",
    forbidden: ["없는 오행 탓에 반드시 갈등이 생긴다", "이 기운은 평생 채울 수 없다"],
    source: "오행 결핍 통설 — 火 부재는 발산의 결핍. 한 만큼 보이게 하는 일이 과제다.",
  },
  {
    id: "OFFICE-MISS-EARTH",
    priority: 66,
    when: { missingElement: ["토"], domains: ["jikjang"] },
    claim: "명식에 土가 비어 관계를 눌러 담는 기운이 밭은 결 — 믿음이 쌓일 때까지 자리를 지키는 것이 과제인 구조",
    safePhrasing: "그런 진득함 보완의 결",
    forbidden: ["없는 오행 탓에 반드시 갈등이 생긴다", "이 기운은 평생 채울 수 없다"],
    source: "오행 결핍 통설 — 土 부재는 담아 두는 기운의 결핍. 오래 머무는 일이 과제다.",
  },
  {
    id: "OFFICE-MISS-METAL",
    priority: 66,
    when: { missingElement: ["금"], domains: ["jikjang"] },
    claim: "명식에 金이 비어 아닌 것을 자르는 기운이 밭은 결 — 거절의 선을 의식해서 세우는 구조",
    safePhrasing: "그런 경계 보완의 결",
    forbidden: ["없는 오행 탓에 반드시 갈등이 생긴다", "이 기운은 평생 채울 수 없다"],
    source: "오행 결핍 통설 — 金 부재는 맺고 끊음의 결핍. 선을 긋는 일이 과제다.",
  },
  {
    id: "OFFICE-MISS-WATER",
    priority: 66,
    when: { missingElement: ["수"], domains: ["jikjang"] },
    claim: "명식에 水가 비어 한 박자 쉬어 듣는 기운이 밭은 결 — 말보다 들음을 의식해서 채우는 구조",
    safePhrasing: "그런 여백 보완의 결",
    forbidden: ["없는 오행 탓에 반드시 갈등이 생긴다", "이 기운은 평생 채울 수 없다"],
    source: "오행 결핍 통설 — 水 부재는 스밈의 결핍. 듣고 고이는 일이 과제다.",
  },
  {
    id: "OFFICE-REL-CLASH",
    priority: 58,
    when: { relationKind: ["지지충"], domains: ["jikjang"] },
    claim: "명식 안의 충이 사람 사이의 마찰로 읽히는 결 — 부딪힘이 관계의 끝이 아니라 자리 조정의 신호가 되는 구조",
    safePhrasing: "그런 조정의 결",
    forbidden: ["그 사람과 반드시 갈라선다", "충이 있어 직장운이 나쁘다"],
    source: "합충 통설 — 지지충은 부딪혀 움직이는 사건. 사람 사이에선 마찰과 재배치로 나타난다.",
  },
];
