...
**기본 문구**
```
1) 인연이 들어오는 시기는 따로 있어요. 창이 열리는 달과 만나게 될 경로를 운의 흐름으로 짚어드려요. 미리보기는 무료예요.
2) 다음 인연이 언제 어디서 오는지, 만남의 경로와 상대의 윤곽까지 함께 봅니다. 전체 리포트는 990원.
3) 소개팅·앱·일상 중 어느 경로가 유리한지는 시기마다 달라요. 창이 닫히기 전 준비까지 확인해보세요. 미리보기 무료.
```

**제목** — `인연의 창이 열리는 시기` / `다음 인연은 언제 어디서?` / `만나게 될 경로까지`
...
> 셋 중 개인 속성 위험이 가장 높다. `헤어지셨나요` 로 한 글자만 기울어도
