...
> **2026-09-03: 한복 버전으로 전면 교체.** 지금은 흐름마다 **정지 그림
> (`rabbit-*-hanbok.webp`) 한 장**만 쓴다 — 힉스필드 nano banana pro 로
> `public/assets/home/welcome-poster.webp` 를 레퍼런스 삼아 생성하고
> 배경을 지웠다(896px 투명 webp). 영상 쌍을 다시 만들 때는 아래 파이프라인
> 그대로, 이 한복 정지 그림을 start_image 로 쓰면 된다.
