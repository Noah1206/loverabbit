...
import { buildSajuFacts, type Gender } from "../saju-facts";
import { advancedMode, type AdvancedMyeongriMode } from "../myeongri/advanced-mode";
import type { AdvancedMyeongriFacts } from "../myeongri/advanced-facts";
import {
  MYEONGRI_SOURCES,
  SOURCE_POLICY_VERSION,
  canBackUserFacingClaim,
  type MyeongriSource,
} from "../myeongri-policy/source-registry";
import {
  CONFLICT_POLICY_ROWS,
  CONFLICT_POLICY_STATUS,
  CONFLICT_POLICY_VERSION,
  CONFLICT_OPEN_QUESTIONS,
} from "../myeongri/advanced-conflict";
import {
  JOHU_TABLE_STATUS,
  JOHU_TABLE_SCOPE,
  JOHU_TABLE_WHY_NOT_120,
} from "../myeongri/johu-assessment";
import {
  STRENGTH_POLICY_STATUS,
  STRENGTH_POLICY_VERSION,
  STRENGTH_OPEN_QUESTIONS,
} from "../myeongri/strength-policy";
import { JOHU_POLICY_STATUS, JOHU_OPEN_QUESTIONS } from "../myeongri/johu";
import { pendingPartnerRules } from "../myeongri-policy/partner-rules";
import GYEOKGUK_POLICY from "../myeongri-policy/gyeokguk-v1.json";
import { axisLabel } from "../myeongri/yongsin";
