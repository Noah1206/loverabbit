...
import { CHEONGAN, JIJI, JIJI_OHAENG, type Ohaeng, type SajuChart } from "../saju";
import { strengthEvidence as rootingEvidence } from "../myeongri/rooting";
import { hiddenStemsOf } from "../myeongri/hidden-stems";
import POLICY from "../myeongri-policy/strength-v1.json";
