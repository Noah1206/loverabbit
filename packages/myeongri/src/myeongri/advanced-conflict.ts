...
import { axisLabel, type YongsinAssessment, type YongsinAxis, type YongsinCandidate } from "../myeongri/yongsin";
import type { SeasonalContext } from "../myeongri/seasonal-context";
import POLICY from "../myeongri-policy/conflict-resolution-v1.json";
