...
import { branchIsYang, calculationPolicyStamp, type CalculationPolicyStamp } from "./myeongri/policy";
import {
  completeXing,
  findXing,
  findXingWithLuck,
...
import { buildRelationBundles, type RelationBundle } from "./myeongri/relation-bundle";
import { hiddenStemsOf, stemElementOf } from "./myeongri/hidden-stems";
import { strengthEvidence, type StrengthEvidence } from "./myeongri/rooting";
import {
  strengthFromPolicy,
...
import { johuEvidence, type JohuEvidence } from "./myeongri/johu";
import { buildAdvancedFacts, type AdvancedMyeongriFacts } from "./myeongri/advanced-facts";
